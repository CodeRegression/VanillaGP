...
public:
	...
	virtual Solution * Breed(InitializerBase * initializer, Solution * mother, Solution * father) override { return nullptr; }
	virtual Solution * Mutate(InitializerBase * initializer, Solution * solution, double probability) override { return nullptr; }
